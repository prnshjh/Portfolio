    ...
    return (
        <div className='border-b border-neutral-900 pb-4'>
            <motion.h2  whileInView={{ opacity: 1, y: 0 }} 
                    ...
                    transition={{ duration: 0.5 }} viewport={{ once: true }}  className='my-20 text-center text-4xl'>Projects</motion.h2>
                ...
                <div key={index} className='mb-8 flex flex-wrap lg:justify-center'>
                    ...
                    transition={{ duration: 1}} viewport={{ once: true }}   className='w-full lg:w-1/4'>
                        <img src={project.image} alt={project.title}
                            height={150} width={150} className='mb-6 rounded' />

                    </motion.div>
                    <motion.div  whileInView={{ opacity: 1, x: 0 }} 
                    initial={{ opacity: 0, x: 100 }} 
                    transition={{ duration: 1}} viewport={{ once: true }}  className='w-full max-w-xl lg:w-3/4'>
                        <a href={project.link} target="_blank" rel="noopener noreferrer" className="hover:text-purple-400 hover:underline">
